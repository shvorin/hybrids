...
2.1  Only prime pieces (neither King nor Pawns) can form a hybrid.

2.2  Equal pieces can also form a hybrid.

2.3  No more than two prime pieces can form a hybrid.
