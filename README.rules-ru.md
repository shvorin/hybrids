...
1.  Ферзь ходит на одну клетку в любом направлении, как и король (т.е. является (0,1)- и (1,1)-прыгуном).
...
2.1  Только простые фигуры могут составлять гибрид (т.е. король и пешки не могут).

2.2  Гибрид могут образовывать две одинаковые фигуры.

2.3  Гибрид может состоять только из двух простых фигур (не более).

3.  Пешки, дошедшие до последней горизонтали, превращаются в любую простую фигуру.

4.  Рокировки нет.

Замечание1: правила 1, 2.3, 4, возможно, кажутся слишком строгими, поэтому есть смысл рассматривать
